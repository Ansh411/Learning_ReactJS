      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-8/12 space-y-6">
          {cartItems.map((item) => (
            ...
            >
              {/* Image */}
              <div className="shrink-0 relative w-28">
                <img
        ...
        <div className="md:w-4/12">
          <div className="p-8 bg-white border border-gray-200 shadow-md rounded-2xl sticky top-28">
            ...
            <Link to="/success">
            <button onClick={() => dispatch(clearCart())}
             className="mt-8 w-full py-4 cursor-pointer bg-orange-500 text-white rounded-xl font-semibold text-xl hover:bg-orange-600 transition shadow-md">
              Complete Order
            </button>
            </Link>
          </div>
