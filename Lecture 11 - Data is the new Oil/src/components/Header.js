        ...
        <div className="header flex justify-between items-center px-8 py-4 shadow-md bg-white sticky top-0 z-50">
            ...
            <div className="nav-items">
                <ul className="flex items-center gap-8 text-lg font-medium">
                    ...
                    <li>
                        <button className="login-btn px-4 py-2 bg-orange-500 text-white cursor-pointer font-semibold rounded-lg hover:bg-orange-600 transition" onClick={() => LoginBtn === "Login" ? setLoginBtn("Logout") : setLoginBtn("Login")}>{LoginBtn}</button>
                    </li>
                    <li className="font-bold hover:text-orange-600 transition">{loggedInUser}</li>
                    <li>
                        <button onClick={() => setUserName("Ansh Gupta")} className="px-4 py-2 bg-orange-500 text-white rounded-lg" >
                        Update Name
                        </button>
                    </li>
                </ul>
